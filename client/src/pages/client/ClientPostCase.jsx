    ...
    <div className="flex flex-col form-group border-2 rounded-lg p-4">
      <div className="container mx-auto p-4">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            (三)
            回饋執行期間，提案人應將資訊公開至區塊鏈公益醫療募款平台平台專案頁面。
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            (五)
            提案人應在回饋執行期間，每月至少更新一次【進度分享】，將資訊公開至區塊鏈公益醫療募款平台平台專案頁面。
          </p>
          <p className="mb-4">
            (六)
            若回饋執行進度延誤，或回饋內容有所變更，提案人應於第一時間內更新【進度分享】，將資訊公開至區塊鏈公益醫療募款平台平台專案頁面。贊助人若因內容變更，而要求變更贊助或退款，提案人不得拒絕或扣除部分費用。
          </p>
          <p className="mb-4">
            (七)
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            (一)
            刊載於區塊鏈公益醫療募款平台平台的公益集資案到期後，只要達到或超過提案人設定的集資金額，區塊鏈公益醫療募款平台平台將自動收取募得總金額8%費用為專案上架費，雙方若有其他約定，需在開始集資前另行議定之。
          </p>
          <p className="mb-4">
            (二)
            如集資案件到期後，未達到提案人設定之集資金額，區塊鏈公益醫療募款平台平台將不收取任何上架費，並於收到金流服務公司撥款後之7至10個工作天(不包含例假日及國定假日)，將集資金額退還予該案之贊助人，惟每筆退款產生之金流手續費，由贊助人自行吸收。此筆費用為支付予金流服務公司之用，而非進入區塊鏈公益醫療募款平台平台帳戶裡。
          </p>
          <p className="mb-4">
            (三)
            專案集資成功後，區塊鏈公益醫療募款平台平台將於收到匯款資料後的7至10個工作天內(不包含例假及國定假日)，將款項以匯款方式匯予提案人指定之受款帳戶。
          </p>
        </div>
        <div className="mb-8">
          ...
          <p className="mb-4">
            (一)
            提案人上載、傳送或提供物件資料或其他相關資料至區塊鏈公益醫療募款平台平台時，視為提案人已授權區塊鏈公益醫療募款平台平台得以利用、儲存及刊載該等資料，以供特定或不特定之使用者搜尋及瀏覽，並視為提案人已授權區塊鏈公益醫療募款平台平台得經由平面或電子形式，重製、散布、公開播送、公開上映、改作、編輯、公開發行、公開發表、或公開傳輸該等資料。
          </p>
          <p className="mb-4">
            (二)
            提案人上載、傳送或提供物件資料或其他相關資料至區塊鏈公益醫療募款平台平台時，應擔保其有上載、傳送或提供該等資料之權利，若該等資料涉有第三人之智慧財產權，提案人保證已取得合法使用之權利，並已取得於區塊鏈公益醫療募款平台平台上使用、公開、播放或公開傳輸該等資料之授權，以免造成區塊鏈公益醫療募款平台平台因此受有損害。
          </p>
          <p className="mb-4">
            (三)
            如有第三人侵犯區塊鏈公益醫療募款平台平台或其使用者的智慧財產權，提案人應協助區塊鏈公益醫療募款平台平台或其使用者進行維權。
          </p>
          <p className="mb-4">
            (四)
            若提案人上載、傳送或提供物件資料或其他相關資料至區塊鏈公益醫療募款平台平台，導致區塊鏈公益醫療募款平台平台或其使用者受有損害，提案人應負賠償責任。
          </p>
        </div>
        <div className="mb-8">
          ...
          <p className="mb-4">
            (一)
            提案人上載、傳送或提供物件資料或其他相關資料至區塊鏈公益醫療募款平台平台時，應遵守相關個資保護法規，不得非法蒐集、處理、使用或揭露他人之個人資料，並遵守區塊鏈公益醫療募款平台平台之隱私權政策。
          </p>
          <p className="mb-4">
            (二)
            若提案人因違反個資保護法規，導致區塊鏈公益醫療募款平台平台或其使用者受有損害，提案人應負賠償責任。
          </p>
        </div>
        <div className="mb-8">
          ...
          <p className="mb-4">
            (一)
            若提案人違反本契約書之規定，區塊鏈公益醫療募款平台平台得隨時終止提案人在區塊鏈公益醫療募款平台平台的資格，並要求提案人賠償因此所生之損害。
          </p>
          <p className="mb-4">
            (二)
            若提案人違反本契約書之規定，導致區塊鏈公益醫療募款平台平台或其使用者受有損害，提案人應負賠償責任。
          </p>
        </div>
        <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            (一)
            本契約書為區塊鏈公益醫療募款平台平台之通則，若與提案人間有其他特別約定，應以該特別約定為準。
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            (三)
            區塊鏈公益醫療募款平台平台保留隨時修改本契約書之權利，修改後之內容將公告於區塊鏈公益醫療募款平台平台網站，不另行通知。提案人應不定期查閱本契約書，以確保其權益。
          </p>
        </div>
      </div>
      <div className="divider"></div>
